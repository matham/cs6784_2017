...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
                 ...
                 n_binary_class=0, binary_only=False):
        ...
        for i in range(n_binary_class):
            bins.append(nn.Linear(num_features, 2))
            setattr(self, 'bin_fc{}'.format(i), bins[-1])

    def reset_final_layer(self):
        reset_layers = [self.classifier] if not self.binary_only else []
    ...
    def forward(self, x):
        ...
        binary_out.insert(0, F.log_softmax(self.classifier(out)))
